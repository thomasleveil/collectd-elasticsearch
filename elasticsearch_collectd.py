...
class Cluster(object):
    ...
    def init_stats(self):
        ...
        self.es_node_url = "http://" + self.es_host + ":" + str(self.es_port) + \
        ...
        if not self.es_index:
            # get all index stats
            self.es_index_url = "http://" + self.es_host + \
        ...
        self.es_cluster_url = "http://" + self.es_host + \
    ...
    def load_es_info(self):
        json = self.fetch_url("http://" + self.es_host + ":" + str(self.es_port) +
                         "/_nodes/_local")
        if json is None:
    ...
    def detect_es_master(self):
        ...
        cluster_state = self.fetch_url("http://" + self.es_host + ":" + str(self.es_port) +
